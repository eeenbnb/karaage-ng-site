...
import { selectBreadcrumbs } from '@shared/store/breadcrumb/breadcrumb.selectors';
...
export class ItemBreadcrumbComponent implements OnInit {
  breadcrumbs$: Observable<{
    breadcrumbs: KaraageBreadcrumbs | undefined;
  }> = this.store.pipe(select(selectBreadcrumbs));
